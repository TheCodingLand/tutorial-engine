...
text : "Si votre navigateur a été détecté correctement, vous devriez voir l'icône correspondante à votre navigateur dans la barre de menu du site. Ces icones représentent dans l'ordre : Google Chrome, Mozilla Firefox, Apple Safari, Microsoft Edge, Opera et Internet Explorer",
...
text : "Trouvez le menu des options",
...
text : "Dans ce menu, il y a une partie \"Applications\", dans le tableau, en face de PDF, changez le comportement de \"apercu dans Firefox\" vers \"Utiliser Adobe Acrobat (Default)\" ",
